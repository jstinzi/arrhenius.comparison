...
pars_v$ID <- as.character(pars_v$ID)
pars_j$ID <- as.character(pars_j$ID)
missingvals <- setdiff(x = pars_j$ID, y = pars_v$ID)
testdat <- pars_v[IDS %in% pars_v$ID,]
testdat2 <- pars_j[pars_j$ID %in% IDS,]
