...
OUR RESPONSE: We thank the reviewer for the references. We would like to point out that there are, in fact, differences in the equations. First, we would
like to address that Long, 1991 does not provide a form of Johnson et al
(1942) - instead it provides a modified Arrhenius that make the
exponential response even steeper than the original. Second, the Lloyd
et al. 1995 equation is exactly the same as the Medlyn et al. 2002 when
algebra is performed on the equations - we now make a specific note that
the Medlyn et al. 2002 equation first appears here. As well, the Harley
& Baldocchi 1995 Topt-based equation is the same as the one presented in
Medlyn et al. 2002. We have since included the Topt equation as well,
even though the output should be equivalent, it is often easier to fit
the Topt version due to nonlinear curve fitting procedures.

The Harley et al. 1986 and 1992 equations are similar to the Johnson et al. 
1942 equation, differing amongst themselves by a single term. We have since 
included these two equations in our analyses. In the process, we also uncovered
another variant in Farquhar et al. 1980, which is similar to Harley et al. 1992.
In any case, all of these equations differ from the original Johnson et al. 1942
equation.
...
OUR RESPONSE: In reading the papers pointed out in point 1 and re-reading Johnson et al. 1942, c'' is actually a constant based on the mathematics (REFS). This is our mistake and we have since corrected it.
...
OUR RESPONSE: We have since refocused the manuscript...
